...
?>
		...
		<div class="row">
			<div class="col-md-9">
				<h3>Resultat de recherche pour : <b><?php echo $query; ?></b></h3>
				...
				{	
					$.ajax({
						...
						beforeSend:function()
						{
							...
							$('#request_button_'+to_id).html('<i class="fa fa-circle-o-notch fa-spin"></i> Envoi...');
						},
						success:function(data)
						{
							$('#request_button_'+to_id).html('<i class="fa fa-clock-o" aria-hidden="true"></i> Envoyé');
						}
					});
				}
